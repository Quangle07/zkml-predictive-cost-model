...
#================================================================================
# ZKML COST MODEL - BLIND TEST VALIDATION 
#================================================================================
#Model Type         | Size   | Actual (s)   | Predicted (s)   | Error (%)
#--------------------------------------------------------------------------------
#MiniCNN            | 12     | 139.67       | 87.07           | 37.66%
#MiniCNN            | 20     | 197.66       | 133.69          | 32.36%
#MiniCNN            | 28     | 243.48       | 180.31          | 25.94%
#TransformerBlock   | 20     | 249.50       | 300.05          | 20.26%
#TransformerBlock   | 24     | 325.89       | 373.28          | 14.54%
#TransformerBlock   | 40     | 460.37       | 792.50          | 72.14%
#--------------------------------------------------------------------------------
#--> Overall Blind Test Mean Absolute Percentage Error (MAPE): 33.82%
#================================================================================
